...
class ENJPKeyboard():
	...
	#textBox = ttk.Entry(frame0, textvariable=entryText, font="Helvetica 32", state='disabled')
	...
	def __init__(self):
		...
		frame1.columnconfigure(4, weight=2)
		frame1.columnconfigure(5, weight=2)
		frame1.columnconfigure(6, weight=2)
		frame1.columnconfigure(7, weight=2)
		frame1.columnconfigure(8, weight=2)
		frame1.columnconfigure(9, weight=2)
		frame1.columnconfigure(10, weight=2)
		frame1.columnconfigure(11, weight=2)
		frame1.columnconfigure(12, weight=2)
		frame1.columnconfigure(13, weight=2)
